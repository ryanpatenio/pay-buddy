        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasCustomize" aria-labelledby="offcanvasCustomizeTitle">
            <div class="offcanvas-body pt-7 pb-5 position-relative">
                ...
                <div class="text-center">
                    ...
                    <h3 class="mb-2" id="offcanvasCustomizeTitle">Customize Your Pay Buddy Theme</h3>
                    <p class="mb-0">Customize your display settings, and we’ll apply them for a better user experience.</p>
                </div>
                <hr>
                <h4 class="mb-0">Color Scheme</h4>
                <p class="text-secondary fs-5 mb-4">Overall light or dark</p>
                ...
                <div class="row gx-4 mt-auto">
                    ...
                    <div class="col-lg mb-3">
                        <button class="btn btn-dark w-100 d-flex align-items-center justify-content-center" id="previewThemeConfig">Save
                        </button>
                    </div>
                </div>
                <!-- / .row -->
