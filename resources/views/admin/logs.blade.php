                    ...
                    <table class="table align-middle table-hover table-nowrap mb-0">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th>
                                    <a href="javascript: void(0);" class="text-muted list-sort" data-sort="status">Ip address
                                    </a>
                                </th>
                                <th>
                        ...
                        <tbody class="list">
                            <tr>
                                ...
                                <td class="key" data-key="FC4A1EFA527">
                                    <div class="d-flex">
                                        <input id="key-01" class="form-control w-350px me-3" value="FC4A1EFA527">
                                        <!-- Button -->
                                ...
                                <td>
                                    ...
                                    <div class="dropdown float-end">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <a class="dropdown-item" href="javascript: void(0);"data-bs-toggle="modal" data-bs-target=".viewLogModal">View
                                                </a>
                                            </li>
