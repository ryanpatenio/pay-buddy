    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidenavCollapse">
            ...
            <ul class="navbar-nav mb-lg-7">
                ...
                <!--Settings--->
                <li class="nav-item">
                <a class="nav-link {{ request()->is('Profile-Account') ||request()->is('Api-keys') || request()->is('Profile-Request') || request()->is('Api-keys-setup') ? 'active' : '' }} " href="#pagesCollapse" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="pagesCollapse">
