"use strict";
(self.webpackChunkdashly = self.webpackChunkdashly || []).push([[427], {
    4632: (t, e, i) => {
        function s(t, e) {
    ...
    6329: (t, e, i) => {
        ...
        const T = t => t <= .0031308 ? 12.92 * t : 1.055 * Math.pow(t, 1 / 2.4) - .055
          , L = t => t <= .04045 ? t / 12.92 : Math.pow((t + .055) / 1.055, 2.4);
        function E(t, e, i) {
            if (t) {
                let s = v(t);
        ...
        function Ht(t, e, i) {
            ...
            if (t._sorted) {
                ...
                d && (n = At(Math.min(Et(r, l, h).lo, i ? s : Et(e, l, a.getPixelForValue(h)).lo), 0, s - 1)),
                o = u ? At(Math.max(Et(r, a.axis, c, !0).hi + 1, i ? 0 : Et(e, l, a.getPixelForValue(c), !0).hi + 1), n, s) - n : s - n
            }
            return {
                start: n,
                count: o
        ...
        function ge(t, e, i, s, n) {
            ...
            if (!(isNaN(p) || p <= 0)) {
                ...
                f) {
                default:
                    n ? t.ellipse(i, s, n / 2, p, 0, 0, ht) : t.arc(i, s, p, 0, ht),
                    t.closePath();
                    break;
                case "triangle":
                    c = n ? n / 2 : p,
        ...
        function Me(t, e, i, s, n, o={}) {
            ...
            l = 0; l < a.length; ++l)
                ...
                B(o.strokeWidth) || (t.lineWidth = o.strokeWidth),
        ...
        function Le(t, e) {
            ...
            s && !("" + s).match(Se) && (console.warn('Invalid font style specified: "' + s + '"'),
            s = void 0);
            const n = {
        ...
        function $e(t, e, i, s) {
            ...
            return null !== l && ((void 0 === o || o === i || (l = Ye(r, a, o, l, s),
            null !== l)) && Ie(Array.from(r), [""], n, o, ( () => function(t, e, i) {
        ...
        function Qe(t, e="x") {
            ...
            !function(t, e, i) {
                ...
                for (let c = 0; c < s - 1; ++c)
                    l = h,
                    h = Ke(t, c + 1),
                    l && h && (xt(e[c], 0, qe) ? i[c] = i[c + 1] = 0 : (n = i[c] / e[c],
                    o = i[c + 1] / e[c],
        ...
        function ei(t, e, i, s, n) {
            ...
            "monotone" === e.cubicInterpolationMode)
                ...
                a = t.length; o < a; ++o)
                    r = t[o],
                    l = Je(i, r, t[Math.min(o + 1, a - (s ? 0 : 1)) % a], e.tension),
                    r.cp1x = l.previous.x,
                    r.cp1y = l.previous.y,
                    r.cp2x = l.next.x,
                    r.cp2y = l.next.y,
            ...
            e.capBezierPoints && function(t, e) {
                ...
                s = t.length; i < s; ++i)
                    ...
                    r = i < s - 1 && pe(t[i + 1], e),
                    o && (n = t[i],
                    a && (n.cp1x = ti(n.cp1x, e.left, e.right),
                    n.cp1y = ti(n.cp1y, e.top, e.bottom)),
                    r && (n.cp2x = ti(n.cp2x, e.left, e.right),
        ...
        function di(t, e, i, s) {
              ...
              , l = function(t, e, i) {
                ...
                if (void 0 === e || void 0 === i) {
                    ...
                    if (o) {
                        ...
                        s = ni(a.maxWidth, o, "clientWidth"),
                        n = ni(a.maxHeight, o, "clientHeight")
                    } else
                        e = t.clientWidth,
                        i = t.clientHeight
                }
            ...
            h = ci(Math.min(h, a, l.maxWidth)),
            c = ci(Math.min(c, r, l.maxHeight)),
            h && !c && (c = ci(h / 2));
        ...
        function Mi({start: t, end: e, count: i, loop: s, style: n}) {
            return {
                start: t % i,
                end: e % i,
                loop: s && (e - t + 1) % i == 0,
        ...
        function wi(t, e, i) {
            ...
            const {property: s, start: n, end: o} = i
              , a = e.length
              , {compare: r, between: l, normalize: h} = vi(s)
              , {start: c, end: d, loop: u, style: f} = function(t, e, i) {
                const {property: s, start: n, end: o} = i
                  , {between: a, normalize: r} = vi(s)
                  , l = e.length;
        ...
        class Li {
            ...
            update(t, e, i) {
                if (this._active) {
                    ...
                    this._total += n,
                    this._loop = !!t.loop,
                    this._to = Ee([t.to, e, s, t.from]),
                    this._from = Ee([t.from, s, e])
                }
            }
            cancel() {
        ...
        class Ei {
            ...
            _createAnimations(t, e) {
                ...
                for (r = o.length - 1; r >= 0; --r) {
                    ...
                    d && d.duration ? (n[l] = c = new Li(d,t,l,h),
                    s.push(c)) : t[l] = h
                }
                return s
            }
            update(t, e) {
                ...
                return i.length ? (Oi.add(this._chart, i),
                !0) : void 0
            }
        }
        function Ri(t, e) {
        ...
        function Bi(t, e) {
            ...
            for (let t = 0; t < d; ++t) {
                const i = e[t]
                  , {[l]: o, [h]: d} = i;
                u = (i._stacks || (i._stacks = {}))[h] = Vi(n, c, o),
                u[r] = d,
                u._top = Wi(u, a, !0, s.type),
                u._bottom = Wi(u, a, !1, s.type);
        ...
        class Yi {
            ...
            updateIndex(t) {
                this.index !== t && Hi(this._cachedMeta),
                this.index = t
            }
            linkScales() {
                const t = this.chart
            ...
            _dataCheck() {
                ...
                if (H(e))
                    ...
                    (s = e)._chartjs ? s._chartjs.listeners.push(n) : (Object.defineProperty(s, "_chartjs", {
                        configurable: !0,
                        enumerable: !1,
                        value: {
                            listeners: [n]
            ...
            buildOrUpdateElements(t) {
                ...
                this._dataCheck();
                const n = e._stacked;
                e._stacked = Fi(e.vScale, e),
                e.stack !== i.stack && (s = !0,
                Hi(e),
                e.stack = i.stack),
                this._resyncElements(t),
                (s || n !== e._stacked) && Bi(this, e._parsed)
            }
            configure() {
            ...
            updateRangeFromParsed(t, e, i, s) {
                ...
                s && a && (s.values = a,
                o = zi(s, n, this._cachedMeta.index)),
        ...
        function Ui(t) {
            ...
            const l = () => {
                32767 !== o && -32768 !== o && (ot(a) && (r = Math.min(r, Math.abs(o - a) || r)),
                a = o)
            }
            ;
            for (s = 0,
        ...
        function Ki(t, e, i, s) {
            ...
            (i._top || 0) === s ? n = h : (i._bottom || 0) === s ? n = c : (o[Gi(c, a, r, l)] = !0,
            n = h)),
            o[Gi(n, a, r, l)] = !0,
            t.borderSkipped = o
        }
                ...
                if (e.grouped) {
                    const i = n ? this._getStackCount(t) : e.stackCount
                      , l = "flex" === s.barThickness ? function(t, e, i, s) {
                        ...
                        let o, a;
                        return B(n) ? (o = e.min * i.categoryPercentage,
        ...
        function Os(t, e, i, s) {
            ...
            for (const r of t) {
                ...
                if (r.horizontal) {
                    ...
                    t.fullSize ? Cs(t, n.left, a, i.outerWidth - n.right - n.left, o) : Cs(t, e.left + l.placed, a, s, o),
                    l.start = a,
                    l.placed += s,
                    a = t.bottom
                } else {
                    ...
                    t.fullSize ? Cs(t, o, n.top, a, i.outerHeight - n.bottom - n.top) : Cs(t, o, e.top + l.placed, a, s),
                    l.start = o,
                    l.placed += s,
                    o = t.right
                }
        ...
        var As = {
            ...
            update(t, e, i, s) {
                ...
                Os(r.leftAndTop, f, d, g),
                f.x += f.w,
                f.y += f.h,
                Os(r.rightAndBottom, f, d, g),
                t.chartArea = {
                    left: f.left,
                    top: f.top,
                    right: f.left + f.w,
        ...
        function Ws(t, e, i) {
            const s = t.canvas
              , n = new MutationObserver((t => {
                let e = !1;
                for (const i of t)
                    e = e || Vs(i.addedNodes, s),
                    e = e && !Vs(i.removedNodes, s);
                e && i()
            }
            ));
        ...
        function $s(t, e, i) {
            ...
            return a.observe(n),
            function(t, e) {
                Ns.size || window.addEventListener("resize", js),
                Ns.set(t, e)
            }(t, o),
            a
        }
        function Ys(t, e, i) {
            ...
            "resize" === e && function(t) {
                Ns.delete(t),
                Ns.size || window.removeEventListener("resize", js)
            }(t)
        }
        function Us(t, e, i) {
            const s = t.canvas
        ...
        function qs(t, e) {
            ...
            if (a > 0) {
                ...
                for (Ks(e, h, c, B(s) ? 0 : r - s, r),
                t = 0,
                i = a - 1; t < i; t++)
                    Ks(e, h, c, o[t], o[t + 1]);
                return Ks(e, h, c, l, B(s) ? e.length : l + s),
                h
            }
            return Ks(e, h, c),
            h
        ...
        class on extends Zs {
            ...
            update(t, e, i) {
                ...
                this._convertTicksToLabels(r ? Qs(this.ticks, a) : this.ticks),
                this.configure(),
                this.beforeCalculateLabelRotation(),
                this.calculateLabelRotation(),
                this.afterCalculateLabelRotation(),
                o.display && (o.autoSkip || "auto" === o.source) && (this.ticks = qs(this, this.ticks),
                this._labelSizes = null,
                this.afterAutoSkip()),
            ...
            generateTickLabels(t) {
                ...
                s = t.length; i < s; i++)
                    n = t[i],
                    n.label = X(e.callback, [n.value, i, t], this)
            }
            ...
            calculateLabelRotation() {
                ...
                a = this.maxHeight - en(t.grid) - e.padding - sn(t.title, this.chart.options.font),
                r = Math.sqrt(c * c + d * d),
                l = wt(Math.min(Math.asin(At((h.highest.height + 6) / o, -1, 1)), Math.asin(At(a / r, -1, 1)) - Math.asin(At(d / r, -1, 1)))),
            ...
            fit() {
                ...
                if (o) {
                    ...
                    t.height = en(n) + o) : (t.height = this.maxHeight,
                    t.width = en(n) + o),
                ...
                for (l = 0; l < e; l += r) {
                    ...
                    B(d) || N(d)) {
                        if (N(d))
                            ...
                            c = d.length; h < c; ++h)
                                x = d[h],
                                B(x) || N(x) || (m = he(s, g.data, g.gc, m, x),
                                b += p)
                    } else
                        m = he(s, g.data, g.gc, m, d),
                        b = p;
                    o.push(m),
                    a.push(b),
                    _ = Math.max(m, _),
            ...
            drawBorder() {
                ...
                const a = s.setContext(this.getContext(0)).lineWidth
                  , r = this._borderValue;
                let l, h, c, d;
                this.isHorizontal() ? (l = de(t, this.left, o) - o / 2,
                h = de(t, this.right, a) + a / 2,
                c = d = r) : (c = de(t, this.top, o) - o / 2,
            ...
            drawTitle() {
                ...
                "bottom" === e || "center" === e || H(e) ? (r += o.bottom,
                N(i.text) && (r += n.lineHeight * (i.text.length - 1))) : r += o.top;
                const {titleX: l, titleY: h, maxWidth: c, rotation: d} = function(t, e, i, s) {
                    ...
                    if (t.isHorizontal()) {
                        ...
                        H(i)) {
                            ...
                            f = "center" === i ? (h.bottom + h.top) / 2 + p - e : Gs(t, i, e);
                        d = r - o
                    } else {
                        if (H(i)) {
                            const t = Object.keys(i)[0]
                            ...
                            u = "center" === i ? (h.left + h.right) / 2 - m + e : Gs(t, i, e);
                        f = Nt(s, a, n),
                        g = "left" === i ? -ft : ft
                    }
                    return {
        ...
        class an {
            ...
            unregister(t) {
                const e = this.items
                  ...
                  , s = this.scope;
                i in e && delete e[i],
                s && i in le[s] && (delete le[s][i],
                this.override && delete se[i])
            }
        }
        class rn {
            constructor() {
                this.controllers = new an(Yi,"datasets",!0),
                this.elements = new an(Zs,"elements"),
                this.plugins = new an(Object,"plugins"),
                this.scales = new an(on,"scales"),
        ...
        class hn {
            ...
            _notify(t, e, i, s) {
                ...
                for (const n of t) {
                    const t = n.plugin;
                    if (!1 === X(t[i], [e, s, n.options], t) && s.cancelable)
                        return !1
                }
                return !0
            }
            invalidate() {
                B(this._cache) || (this._oldCache = this._cache,
                this._cache = void 0)
            }
            _descriptors(t) {
                if (this._cache)
        ...
        function dn(t, {plugin: e, local: i}, s, n) {
        ...
        class wn {
            ...
            resolveNamedOptions(t, e, i, s=[""]) {
                const n = {
                  ...
                  , {resolver: o, subPrefixes: a} = kn(this._resolverCache, t, s);
                let r = o;
                if (function(t, e) {
        ...
        function Tn(t) {
            return ii() && "string" == typeof t ? t = document.getElementById(t) : t && t.length && (t = t[0]),
        ...
        class In {
            ...
            constructor(t, e) {
                ...
                this.platform = new (i.platform || function(t) {
                    return !ii() || "undefined" != typeof OffscreenCanvas && t instanceof OffscreenCanvas ? Ls : Xs
                }(s)),
                ...
                this._dataChanges = [],
                Ln[this.id] = this,
                a && r ? (Oi.listen(this, "complete", On),
                Oi.listen(this, "progress", An),
                this._initialize(),
            ...
            _resize(t, e) {
                ...
                this._aspectRatio = this.aspectRatio,
                ui(this, a, !0) && (this.notifyPlugins("resize", {
                    size: o
                }),
            ...
            buildOrUpdateScales() {
                ...
                Z(n, (e => {
                    const n = e.options
                      ...
                      , a = gn(o, n)
                      , r = Y(n.type, e.dtype);
                    void 0 !== n.position && Dn(n.position, a) === Dn(e.dposition) || (n.position = e.dposition),
                    s[o] = !0;
                    let l = null;
            ...
            buildOrUpdateControllers() {
                ...
                s = e.length; i < s; i++) {
                    ...
                    n.type = o,
                    n.indexAxis = s.indexAxis || un(o, this.options),
                    n.order = s.order || 0,
                    n.index = i,
                    n.label = "" + s.label,
            ...
            _checkEventBindings() {
                const t = this.options
                  ...
                  , i = new Set(t.events);
                rt(e, i) && !!this._responsiveListeners === t.responsive || (this.unbindEvents(),
                this.bindEvents())
            }
            ...
            render() {
                !1 !== this.notifyPlugins("beforeRender", {
                    cancelable: !0
                }) && (Oi.has(this) ? this.attached && !Oi.running(this) && Oi.start(this) : (this.draw(),
                On({
                    chart: this
                })))
            }
        ...
        function Wn(t, e, i, s, n, o) {
            ...
            const p = (g - Math.max(.001, g * d - i / lt) / d) / 2
              , m = l + p + f
              , b = n - p - f
              , {outerStart: x, outerEnd: _, innerStart: y, innerEnd: v} = Fn(e, u, d, b - m)
              , M = d - x
              , w = d - _
              , k = m + x / M
              , S = b - _ / w
        ...
        function Bn(t, e, i, s, n) {
            ...
            f && function(t, e, i) {
                ...
                t.arc(o, a, r, s - h, i + h),
                l > n ? (h = n / l,
                t.arc(o, a, l, i + h, s - h, !0)) : t.arc(o, a, n, i + ft, s - ft),
                t.closePath(),
                t.clip()
            }(t, e, g),
            o || (Wn(t, e, i, s, g, n),
        ...
        class Jn extends Zs {
            ...
            draw(t, e) {
                const i = this.options;
                this.skip || i.radius < .1 || !pe(this, e, this.size(i) / 2) || (t.strokeStyle = i.borderColor,
            ...
            const n = function(t) {
                ...
                if (e.getPointPositionForValue)
                    return function(t) {
                        const {scale: e, fill: i} = t
                          ...
                          , a = function(t, e, i) {
                            let s;
                            return s = "start" === t ? i : "end" === t ? e.options.reverse ? e.min : e.max : H(t) ? t.value : e.getBaseValue(),
                            s
                        }(i, e, o)
                          , r = [];
                        if (s.grid.circular) {
                ...
                return function(t) {
                    const {scale: e={}, fill: i} = t
                      , s = function(t, e) {
                        let i = null;
                        return "start" === t ? i = e.bottom : "end" === t ? i = e.top : H(t) ? i = e.getPixelForValue(t.value) : e.getBasePixel && (i = e.getBasePixel()),
                        i
                    }(i, e);
                    if (j(s)) {
        ...
        class Co extends Zs {
            ...
            _draw() {
                const {options: t, columnSizes: e, lineWidths: i, ctx: s} = this
                  , {align: n, labels: o} = t
                  , a = le.color
                  , r = xi(t.rtl, this.left, this.width)
                  , l = Le(o.font)
                  , {padding: h} = o
                  , c = l.size
                  , d = c / 2;
                ...
                s.lineWidth = .5,
                s.font = l.string;
                const {boxWidth: f, boxHeight: g, itemHeight: p} = Do(o, c)
                  , m = this.isHorizontal()
                ...
                this.legendItems.forEach(( (_, y) => {
                    ...
                    u.line++,
                    k = u.x = Nt(n, this.left + h, this.right - i[u.line])) : y > 0 && S + x > this.bottom && (k = u.x = k + e[u.line].width + h,
                    u.line++,
                    ...
                    if (function(t, e, i) {
                        ...
                        if (s.fillStyle = Y(i.fillStyle, a),
        ...
        class To extends Zs {
            ...
            _drawArgs(t) {
                const {top: e, left: i, bottom: s, right: n, options: o} = this
                  , a = o.align;
                let r, l, h, c = 0;
                return this.isHorizontal() ? (l = Nt(a, i, n),
                h = e + t,
        ...
        function Bo(t, e, i, s) {
            const {caretSize: n, caretPadding: o, cornerRadius: a} = t
              , {xAlign: r, yAlign: l} = i
              , h = n + o
              , {topLeft: c, topRight: d, bottomLeft: u, bottomRight: f} = Ae(a);
            let g = function(t, e) {
                let {x: i, width: s} = t;
        ...
        class Uo extends Zs {
            ...
            getTitle(t, e) {
                const {callbacks: i} = e
                  , s = Yo(i, "beforeTitle", this, t)
                  , n = Yo(i, "title", this, t)
                  , o = Yo(i, "afterTitle", this, t);
                let a = [];
                return a = Ro(a, Io(s)),
                a = Ro(a, Io(n)),
                a = Ro(a, Io(o)),
            ...
            getBody(t, e) {
                ...
                return Z(t, (t => {
                    const e = {
                      ...
                      , n = jo(i, t);
                    Ro(e.before, Io(Yo(n, "beforeLabel", this, t))),
                    Ro(e.lines, Yo(n, "label", this, t)),
                    Ro(e.after, Io(Yo(n, "afterLabel", this, t))),
                    s.push(e)
                }
                )),
                s
            ...
            getFooter(t, e) {
                const {callbacks: i} = e
                  , s = Yo(i, "beforeFooter", this, t)
                  , n = Yo(i, "footer", this, t)
                  , o = Yo(i, "afterFooter", this, t);
                let a = [];
                return a = Ro(a, Io(s)),
                a = Ro(a, Io(n)),
                a = Ro(a, Io(o)),
            ...
            _createItems(t) {
                ...
                Z(l, (e => {
                    ...
                    s.push(Yo(i, "labelColor", this, e)),
                    n.push(Yo(i, "labelPointStyle", this, e)),
                    o.push(Yo(i, "labelTextColor", this, e))
                }
                )),
                this.labelColors = s,
            ...
            getCaretPosition(t, e, i) {
                const {xAlign: s, yAlign: n} = this
                  ...
                  , {topLeft: r, topRight: l, bottomLeft: h, bottomRight: c} = Ae(a)
                  , {x: d, y: u} = t
                  , {width: f, height: g} = e;
                let p, m, b, x, _, y;
            ...
            _drawColorBox(t, e, i, s, n) {
                ...
                if (n.usePointStyle) {
                    ...
                    t.lineWidth = H(o.borderWidth) ? Math.max(...Object.values(o.borderWidth)) : o.borderWidth || 1,
                    t.strokeStyle = o.borderColor,
            ...
            drawBackground(t, e, i, s) {
                const {xAlign: n, yAlign: o} = this
                  , {x: a, y: r} = t
                  , {width: l, height: h} = i
                  , {topLeft: c, topRight: d, bottomLeft: u, bottomRight: f} = Ae(s.cornerRadius);
        ...
        function Go(t, e) {
            ...
            w = l - 1,
            k = (M - v) / w) : (w = (M - v) / k,
            w = xt(w, Math.round(w), k / 1e3) ? Math.round(w) : Math.ceil(w));
            const S = Math.max(kt(k), kt(v));
            y = Math.pow(10, B(r) ? S : r),
            v = Math.round(v * y) / y,
            M = Math.round(M * y) / y;
            let P = 0;
            for (m && (d && v !== o ? (i.push({
            ...
            v < o && P++,
            xt(Math.round((v + P * k) * y) / y, o, Jo(o, _, t)) && P++) : v < o && P++); P < w; ++P) {
        ...
        class aa extends on {
            ...
            determineDataLimits() {
                ...
                this._zero && this.min !== this._suggestedMin && !j(this._userMin) && (this.min = t === ia(this.min, 0) ? ia(this.min, -1) : ia(this.min, 0)),
                this.handleTickRangeOptions()
            }
            handleTickRangeOptions() {
                const {minDefined: t, maxDefined: e} = this.getUserBounds();
            ...
            getPixelForValue(t) {
                ...
                null === t || isNaN(t) ? NaN : this.getPixelForDecimal(t === this.min ? 0 : (mt(t) - this._startValue) / this._valueRange)
            }
            getValueForPixel(t) {
        ...
        class pa extends Qo {
            ...
            setDimensions() {
                const t = this._padding = Te(ra(this.options) / 2)
            ...
            drawBackground() {
                ...
                if (t) {
                    ...
                    i.save(),
                    i.beginPath(),
                    ga(this, this.getDistanceFromCenterForValue(this._endValue), e, this._pointLabels.length),
                    i.closePath(),
                    i.fillStyle = t,
                    i.fill(),
                    i.restore()
        ...
        function _a(t, e) {
            ...
            j(a) || (a = "string" == typeof s ? i.parse(a, s) : i.parse(a)),
            null === a ? null : (n && (a = "week" !== n || !yt(o) && !0 !== o ? i.startOf(a, n) : i.startOf(a, "isoWeek", o)),
            +a)
        }
        function ya(t, e, i, s) {
            const n = ba.length;
        ...
        class wa extends on {
            ...
            determineDataLimits() {
                ...
                s = j(s) && !isNaN(s) ? s : +e.startOf(Date.now(), i),
                n = j(n) && !isNaN(n) ? n : +e.endOf(Date.now(), i) + 1,
            ...
            buildTicks() {
                ...
                return this._unit = e.unit || (i.autoSkip ? ya(e.minUnit, this.min, this.max, this._getLabelCapacity(n)) : function(t, e, i, s, n) {
                    for (let o = ba.length - 1; o >= ba.indexOf(i); o--) {
                        const i = ba[o];
                        if (ma[i].common && t._adapter.diff(n, s, i) >= e - 1)
                            return i
                    }
            ...
            _generate() {
                ...
                d++)
                    va(h, c, f);
                return c !== i && "ticks" !== s.bounds && 1 !== d || va(h, c, f),
                Object.keys(h).sort(xa).map((t => +t))
            }
            getLabelForValue(t) {
        ...
        class Sa extends wa {
            ...
            initOffsets() {
                ...
                this._minPos = ka(e, this.min),
                this._tableRange = ka(e, this.max) - this._minPos,
                super.initOffsets(t)
            }
            buildLookupTable(t) {
        ...
        In.register(Nn, Kn, oo, Jn, ts, es, is, ss, os, ns, as, rs, Ko, ta, aa, pa, wa, Sa, lo, Po, Ao, Lo, Xo);
        const Pa = s.Z("--prefix")
            ...
            draw() {
                ...
                t.forEach(( (i, s) => {
                    ...
                    if (0 == s || s == t.length - 2) {
                        ...
                        e.save(),
                        e.translate(n.x, n.y),
                        0 === s ? (e.fillStyle = n.backgroundColor || i,
                        e.beginPath(),
                        e.arc(o * Math.sin(r), o * Math.cos(r), a, 0, 2 * Math.PI),
                        e.fill(),
                        s === t.length - 2 && (e.fillStyle = n.backgroundColor || i,
                        e.beginPath(),
                        e.arc(o * Math.sin(l), o * Math.cos(l), a, 0, 2 * Math.PI),
                        e.fill())) : (e.fillStyle = n.backgroundColor || i,
                        e.beginPath(),
                        e.arc(o * Math.sin(l), o * Math.cos(l), a, 0, 2 * Math.PI),
                        e.fill()),
                        e.restore()
        ...
        Ca.id = "roundedDoughnut",
        Ca.defaults = is.defaults,
        In.register(Ca),
        In.register({
            id: "mouseLine",
            afterEvent(t) {
                const e = t;
                t.options.plugins.mouseLine.enabled && (e.options.plugins.mouseLine.x = !1,
            ...
            afterDatasetsDraw(t) {
                ...
                const e = t.ctx
                  , i = t.chartArea;
                (t.options.plugins.mouseLine.x || !1) && (e.save(),
                e.strokeStyle = t.options.plugins.mouseLine.color || s.Z(`${Pa}secondary`),
        ...
        In.defaults.maintainAspectRatio = !1,
        In.defaults.responsive = !0,
        In.defaults.font.family = s.Z(`${Pa}font-sans-serif`),
        In.defaults.font.color = s.Z(`${Pa}gray-500`),
        In.defaults.font.size = 12,
        In.defaults.layout.padding = 0,
        In.defaults.plugins.title.display = !1,
        In.defaults.plugins.legend.display = !1,
        In.defaults.plugins.legend.labels.usePointStyle = !0,
        In.defaults.plugins.legend.labels.pointStyle = "circle",
        In.defaults.plugins.legend.align = "end",
        In.defaults.elements.point.radius = 0,
        In.defaults.elements.point.backgroundColor = s.Z(`${Pa}primary`),
        In.defaults.scale.grid.color = s.Z(`${Pa}border-color-translucent`),
        In.defaults.scale.border.display = !1,
        In.defaults.scale.border.dash = [6, 6],
        In.defaults.scale.grid.zeroLineColor = s.Z(`${Pa}border-color-translucent`),
        In.defaults.scale.ticks.color = s.Z(`${Pa}gray-500`),
        In.defaults.scales.category.grid = {
            drawBorder: !1,
            drawOnChartArea: !1,
            drawTicks: !1
        },
        In.defaults.elements.line.tension = .4,
        In.defaults.elements.line.borderWidth = 3,
        In.defaults.elements.line.borderColor = s.Z(`${Pa}primary`),
        In.defaults.elements.line.backgroundColor = "transparent",
        In.defaults.elements.line.borderCapStyle = "rounded",
        In.defaults.elements.line.fill = !0,
        In.defaults.datasets.bar.barThickness = 13,
        In.defaults.elements.arc.borderWidth = 0,
        In.defaults.elements.arc.hoverBorderColor = s.Z(`${Pa}white`),
        In.defaults.datasets.doughnut.cutout = "87.5%",
        In.defaults.datasets.roundedDoughnut.cutout = "87.5%",
        In.defaults.datasets.doughnut.borderWidth = 3,
        In.defaults.datasets.doughnut.borderColor = s.Z(`${Pa}white`),
        In.defaults.interaction.intersect = !1,
        In.defaults.plugins.tooltip.enabled = !1,
        In.defaults.plugins.tooltip.usePointStyle = !0,
        In.defaults.plugins.tooltip.boxWidth = 8,
        In.defaults.plugins.tooltip.backgroundColor = s.Z(`${Pa}dark`),
        In.defaults.plugins.tooltip.xPadding = 10,
        In.defaults.plugins.tooltip.yPadding = 10,
        In.defaults.plugins.tooltip.bodyColor = s.Z(`${Pa}white`),
        In.defaults.plugins.tooltip.hasIndicator = !0,
        In.defaults.plugins.tooltip.indicatorWidth = "8px",
        In.defaults.plugins.tooltip.indicatorHeight = "8px",
        In.defaults.plugins.tooltip.titleColor = s.Z(`${Pa}white`),
        In.defaults.plugins.tooltip.external = t => {
            ...
            i.yAlign ? e.classList.add(i.yAlign) : e.classList.add("no-transform");
            const o = t => t.lines;
            if (i.body) {
                const t = i.title || []
                  , a = i.body.map(o);
                ...
                a.forEach(( (t, e) => {
                    ...
                    i.labelColors[e].backgroundColor == s.Z(`${Pa}chart-tooltip-bg`) && (document.documentElement.dataset.theme,
                    o = n.Z(i.labelColors[e].backgroundColor, 0)),
                    i.labelColors[e].backgroundColor instanceof Object && (o = s.Z(`${Pa}primary`)),
                    r += "<div>",
                    r += (i.options.hasIndicator ? `<span class="d-inline-block rounded-circle me-1" style="width: ${i.options.indicatorWidth}; height: ${i.options.indicatorHeight}; background-color: ${o}"></span>` : "") + t,
                    r += "</div>"
                }
                )),
                r += "</div>";
        ...
        Da.length && Da.forEach((t => {
            t.addEventListener("click", (e => {
                ...
                "visibility" === t.dataset.action && t.querySelector(".nav-link").classList.toggle("text-decoration-line-through")
            }
            ))
        }
        )),
